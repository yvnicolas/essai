...
public class AddContactActivity extends Activity {
	...
	public void addContact(View v) {
		...
		if (accounts.length > 0) {
			...
			if ((((EditText) findViewById(R.id.edit_contactid)).getText().toString().equals(""))) {
				Toast.makeText(this, "Enter a valid ID!", Toast.LENGTH_LONG).show();
			} else {
				int contactId = Integer.valueOf(((EditText) findViewById(R.id.edit_contactid)).getText().toString());
